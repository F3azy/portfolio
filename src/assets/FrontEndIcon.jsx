...
const FrontEndIcon = (props) => {
    return (
        <Icon {...props} viewBox="0 0 262 220" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0_89_188)">
        <rect x="2" y="2" width="246" height="146" rx="6" fill="#BCBCBC"/>
        <rect x="2" y="2" width="246" height="146" rx="6" stroke="black" strokeWidth="4"/>
        ...
        <rect x="12" y="12" width="226" height="126" rx="2" stroke="black" strokeWidth="4"/>
        <rect x="102" y="148" width="46" height="36" fill="#7E7E7E"/>
        <rect x="102" y="148" width="46" height="36" stroke="black" strokeWidth="4"/>
        <rect x="77" y="184" width="96" height="11" rx="5.5" fill="#BCBCBC"/>
        <rect x="77" y="184" width="96" height="11" rx="5.5" stroke="black" strokeWidth="4"/>
        <g clipPath="url(#clip1_89_188)">
        ...
        <rect x="194" y="102" width="66" height="116" rx="6" stroke="black" strokeWidth="4"/>
        </g>
        <defs>
